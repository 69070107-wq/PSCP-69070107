...
```text
โจทย์ให้คำนวณราคาที่ลูกค้าต้องชำระเงิน เรียบร้อยแล้วค่าบริการไว้ 10% ของราคาอาหาร แต่คิดอย่างน้อย 50 บาท แต่จะไม่เกิน 1000 และการคิด VAT อีก 7% จากราคาที่ได้รวมค่าอาหารและบริการแล้ว
Input:
จำนวนเงินค่าx

Output:
ผลรวมที่ลูกค้าต้องชำระเงินหลังจากได้รวมค่าบริการและ VAT 7%
...
```text
Step 1: รับค่าจำนวนเต็มx
Step 2: ให้yมีค่าเป็นค่าบริการโดยคิดจาก(x *10) / 100
Step 3: ถ้าค่าบริการมีค่ามากกว่า1000ให้yมีค่าเท่ากับ1000เพราะเป็นลิมิตค่าบริการสูงสุด
Step 4: ถ้าค่าบริการมีค่าน้อยกว่า50ให้yมีค่าเท่ากับ50เพราะเป็นลิมิตค่าบริการต่ำสุด
Step 5:ให้zมีค่าเป็นบริการรวมกับจำนวนเงิน
Step 6:หาค่าvatโดยการ(z *7) / 100และเก็บไว้ในตัวแปรvat
Step 7:ให้totalมีค่าคือz+vatจะได้ผลลัพธ์ที่ต้องการ
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก รับค่าจำนวนเต็มx ให้yมีค่าเป็นค่าบริการโดยคิดจาก(x *10) / 100ถ้าค่าบริการมีค่ามากกว่า1000ให้yมีค่าเท่ากับ1000เพราะเป็นลิมิตค่าบริการสูงสุด ถ้าค่าบริการมีค่าน้อยกว่า50ให้yมีค่าเท่ากับ50เพราะเป็นลิมิตค่าบริการต่ำสุด ให้zมีค่าเป็นบริการรวมกับจำนวนเงิน หาค่าvatโดยการ(z *7) / 100และเก็บไว้ในตัวแปรvat ให้totalมีค่าคือz+vatจะได้ผลลัพธ์ที่ต้องการ
...
```text
ทดสอบว่าเมื่อใส่inputไปแล้วเงื่อนไขผลลัพธ์ตรงกับoutputที่ต้องการ
```
