...
```text
หาว่าระยะทางของกบกระโดดกี่ครั้งและไปถึงไหม
input 
กบโดดครั้งแรก
output
กบโดดกี่ครั้ง
...
```text
รับค่าตัวแปร2ตัวตัวเป็นจำนวนเต็ม
ใช้ลูปถ้าระยะทางที่ลบแล้วยังไม่เป็น0
ให้ระยะทาง-กระโดด
ให้กระโดด-2ตามโจทย์ที่บอก
และสร้างตัวแปรเก็บค่าการกระโดด+1
เมื่อออกลูปมาให้เช็คว่าระยะทางยังมีค่ามากกว่า0ไหมถ้าใช่ให้แสดง-1แปลว่าไปไม่ถึง
นอกเหนือจากนั้นให้แสดงจำนวนของตัวแปรที่เก็บค่า
...
```text
เช็คตรวจสอบความผิดพลาดจากโจทย์
```
...
```text
เช็คตรวจสอบความผิดพลาดว่าสามารถทำงานได้อย่างปกติ
```
