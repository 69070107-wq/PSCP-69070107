...
Input:
โปรแกรมรับจำนวนเต็มหนึ่งค่า จำนวนNคน จำนวนที่ส่งต่อKคน คนที่เป็นขโมยT
...
```text
รับค่าข้อมูลจำนวนNคน จำนวนที่ส่งต่อKคน คนที่เป็นขโมยT
เช็คถ้าTมีค่า=1ให้แสดงผลลัพเป็น1
ถ้านอกเหนือจากนั้นให้ใช้ลูปหาคนถัดไปที่จะได้ตรวจจาก person = (person + K - 1) % N + 1
และเช็คอีกว่าpersonมีค่าเท่ากับTให้บวก1จำนวนเก็บและแสดงค่าและอีกลูป แต่ถ้ายังไม่ตรงเงื่อนไขให้บวก1จำนวนเก็บ
```
...
```text
เพื่อทดสอบว่าตรงตามเงื่อนไขไม่ผิดหลาดตามโจทย์
```
...
```text
ตรวจสอบว่ามีTเท่ากับ1จะตรงตามเงื่อนไข
```
