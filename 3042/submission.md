...
```text
โปรแกรมตรวจสอบว่าตัวเลขที่หาร10ลงตัว
...
Step 2: ใช้ลูปลบค่าถ้าหาร10ไม่ลงตัวให้nเป็นเลขที่หาร10ลงตัว
Step 3: ลูปลบค่าnที่ละ10และเก็บค่าไว้อีกตัวแปรy
Step 4: แสดงค่าตัวแปรy
```
...
```text
อ่านจำนวนเต็ม nใช้ลูปลบค่าถ้าหาร10ไม่ลงตัวให้nเป็นเลขที่หาร10ลงตัวลูปลบค่าnที่ละ10และเก็บค่าไว้อีกตัวแปรyแสดงค่าตัวแปรy
```
...
```text
ตรวจสอบว่าโค้ดทำงานได้อย่างไม่มีผิดพลาดทำงานอย่างถูกต้อง
```
