...
```text
โจทย์ให้ทำการเปลี่ยนหน่วยอุณหภูมิต่างๆ
Input:
เลขอุณหภูมิ temp
หน่วยของอุณหภูมิก่อนจะเปลี่ยน
หน่วยของอุหณภูมิที่ต้องการ
Output:
โปรแกรมควรแสดงอุณหภูมิของหน่วยที่ต้องการ
...
```text
Step 1: เลขอุณหภูมิ temp หน่วยของอุณหภูมิก่อนจะเปลี่ยน หน่วยของอุหณภูมิที่ต้องการ
Step 2: ตรวจว่าหน่วยของอุณหภูมิก่อนจะเปลี่ยนแปลงหน่วยเป็นCelsius
Step 3: ตรวจว่าหน่วยของอุหณภูมิที่ต้องการเป็นตัวอักษรอะไรแล้วให้คำนวณตามหน่วยของตัวอักษรนั้นโดยตัวอักษรก่อนแปลงถือว่ามีค่าเป็นหน่วยCelsius
Step 4: แสดงผลลัพของอุณหภูมิหน่วยของอุหณภูมิที่ต้องการ
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก Step 1: เลขอุณหภูมิ temp หน่วยของอุณหภูมิก่อนจะเปลี่ยน หน่วยของอุหณภูมิที่ต้องการ
Step 2: ตรวจว่าหน่วยของอุณหภูมิก่อนจะเปลี่ยนแปลงหน่วยเป็นCelsius
Step 3: ตรวจว่าหน่วยของอุหณภูมิที่ต้องการเป็นตัวอักษรอะไรแล้วให้คำนวณตามหน่วยของตัวอักษรนั้นโดยตัวอักษรก่อนแปลงถือว่ามีค่าเป็นหน่วยCelsius
Step 4: แสดงผลลัพของอุณหภูมิหน่วยของอุหณภูมิที่ต้องการ
```
...
```text
เพื่อตรวจสอบว่าผลลัพธ์ของการเปลี่ยนแปลงหน่วยถูกต้องหรือไม่
```
