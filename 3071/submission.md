...
```text
หาค่าความเชื่องโยงระหว่างตัวเลขก็คือ จำนวนเลขที่อยู่ในช่วงaถึงbที่หารdและมีเศษเท่ากับr
```
...
รับค่าตัวแปร4ตัว
สร้างตัวแปรเก็บค่า
ใช้for loop โดยให้วนb+1ครั้งและเริ่มต้นที่a
เช็คในลูปว่า i หาร d แล้วมีเศษเท่ากับ r ไหม if i % d == r: ถ้าใช่ให้ตัวแปรเก็บค่าบวก1
แสดงค่าของตัวแปรเก็บค่า
```
...
```text
เพื่อเช็คว่าสามารถผ่านเงื่อนไขของโจทย์และตรวจสอบว่าไม่มีerror
```
