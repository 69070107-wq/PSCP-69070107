...
```text
มีช่วงเวลาหลายช่วง โดยแต่ละช่วงมี เวลาเริ่ม (start) และ เวลาจบ (stop) แล้วโจทย์จะถามเวลาที่กำหนดหลายเวลา เราต้องตอบว่า ในเวลานั้นมีช่วงที่กำลังเกิดขึ้นอยู่กี่ช่วง
```
...
```text
Step 1: รับจำนวนช่วงเวลา
Step 2: รับเวลาเริ่มและเวลาจบของแต่ละช่วง
Step 3: เก็บจำนวนช่วงที่เกิดขึ้นในแต่ละเวลา
Step 4: รับเวลาที่ต้องการตรวจสอบ
Step 5: แสดงจำนวนช่วงที่กำลังเกิดขึ้นในเวลานั้น
```
...
```text
เพื่อตรวจสอบความถูกต้องที่โจทย์ต้องการ
```
