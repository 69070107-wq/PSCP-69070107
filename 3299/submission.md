...
```text
โจทย์ให้ L และ N แล้วให้ปลูกดอกไม้ตามแนวทแยงจนถึงช่องที่ N ต้องหาว่าช่องสุดท้ายอยู่ แถบที่เท่าไร
input
L = ขนาดของแถบ
N = จำนวนช่องที่ปลูก
Output
หมายเลขแถบของช่องที่ N
```
...
```text
รับค่าตัวแปรเป็นตัวเลข
สร้างตัวแปร2ตัวให้=0
ใช้while loop เช็คว่า ค่าtotalืั้เป็นตัวแปรที่สร้างขึ้นน้อยกว่าจำนวนช่องที่ปลูกยัง
ถ้ายัง ให้ total+=diagonalที่เป็นที่แปรที่สร้างมาอีกตัวก่อนหน้า
แสดงค่าของหมายเลขของแถบของช่องสุดท้ายที่มีการปลูกดอกไม้โดยใช้(diagonal - 1) // l + 1
```
...
```text
ตรวจสอบตามเทสเคสที่ให้มาจากโจทย์ว่าถูกต้องไหม
```
...
```text
ตรวจสอบความถูกต้องว่ามีการผิดพลาดหรือerrorไหม
```
