...
```text
โจทย์ให้ฉันรับสถานะสมาชิกและจำนวนสินค้า แล้วคำนวณราคาสินค้ารวมพร้อมส่วนลดตามเงื่อนไข

Input:
โปรแกรมรับสถานะสมาชิก Y หรือ N จำนวนสินค้า และราคาสินค้าแต่ละรายการ

Output:
โปรแกรมควรพิมพ์ราคาสุทธิหลังหักส่วนลด โดยแสดงทศนิยม 2 ตำแหน่ง

Constraints:
ราคาสินค้าเป็นตัวเลข และต้องตรวจสอบเงื่อนไขส่วนลดของสมาชิกและยอดซื้อขั้นต่ำ 500 บาท
```
...
```text
Step 1: รับสถานะสมาชิกและจำนวนสินค้า
Step 2: รับราคาสินค้าแต่ละรายการแล้วนำมารวมกัน
Step 3: ถ้าเป็นสมาชิกให้ลด 5%
Step 4: ถ้าไม่เป็นสมาชิกและยอดรวมตั้งแต่ 500 บาทขึ้นไปให้ลด 3%
Step 5: ถ้าไม่เข้าเงื่อนไขให้ใช้ราคาปกติ
Step 6: แสดงราคาสุทธิ 2 ตำแหน่ง
```
...
```text
เพื่อตรวจสอบเทสเคสว่ามีความถูกต้องตามหลักการของข้อนี้
```
...
```text
เพื่อตรวจสอบเทสเคสว่ามีความถูกต้องตามเทสเคสไหม
```
