...
```text
รับค่าโดยใช้ตัวแปรxและใช้.lower()ตัวอักษรที่รับมาเป็นพิมพ์เล็กและให้แสดงค่าโดยใช้[::-1]เพื่อให้แสดงค่าxหลังสุดก่อน
```
...
```text
Step 1:รับค่าโดยใช้ตัวแปรx
Step 2:ใช้.lower()
Step 3:แสดงค่าโดยใช้[::-1]
```
...
```text
ให้รับค่าเป็นตัวอักษรและปรับเป็นพิมพ์เล็กและแสดงค่าxแบบย้อนกลับ
```
...
```text
เพื่อเช็คว่าผลลัพธ์ตรงกับที่โจทย์ให้มาไหม
```
...
```text
เพื่อเช็คว่าเมื่อรับค่ามาแล้วผลลัพธ์จะออกมาเป็นพิมพ์เล็ก
```
