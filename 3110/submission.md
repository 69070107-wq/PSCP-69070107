...
```text
ให้แสดงราคาของการส่งพัสดุจากที่หนึ่งไปอีกที่โดยกำหนดจุดเริ่มต้นและปลายทาง
input 
เป็นนจุดเริ่ม จุดปลายทาง
ขนาดน้ำหนักของ
Output
ราคาน้ำของและค่าส่ง
```
...
```text
รับค่าจุดเริ่มและจุดปลายทาง
รับค่า น้ำนหนักของ
กำหนดค่าตัวแปรราคาให้=0
ตรวจสอบถ้าจุดเริ่มและจุดปลายทางตรงกับอันไหนให้บวกค่าตัวแปรราคาตามตารางที่โจทย์ให้กับค่าธรรมเนียม
ถ้านอกเหนือจากนั้นให้แสดงค่า Error
```
...
```text
เพื่อทดสอบว่าตรงกับที่โจทย์ให้มาและไม่มีข้อผิดพลาด
```
