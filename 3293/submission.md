...
รับข้อความมา5บรรทัด
output
แสดงข้อคว้ามนั้นพร้อมกับมี*ล้อมเป็นกรอบ
```
...
```text
ใช้for loop ในการรับค่าตัวแปร5บรรทัด
และตัวแปรnคือจำนวนตัวอักษรของบรรทัดที่มีค่ามากสุด
แสดง*แถวแรกเท่าจำนวนn+4
ใช้for loopแสดง*และค่าของตัวอักษรตำแหน่งiและจำนวนช่องว่างที่ต้องเติมหลังข้อความ เพื่อให้ทุกบรรทัดยาวเท่ากันและแสดง*
แสดง*แถวแรกเท่าจำนวนn+4
```
...
```text
เช็คและตรวจสอบความถูกต้องว่าเกิดข้อผิดพลาดไหม
```
...
```text
เช็คและตรวจสอบความถูกต้องว่าเกิดข้อผิดพลาดตามโจทย์ไหม
```
