...
```text
ต้องการรู้ว่าใช้หินก้อนเล็กไปเท่าไหร่จากเป้าหมายที่ต้องการโดยมีหินใหญ่และเล็กในการเติมให้ถึงเป้าหมาย
input 
หินเล็ก
หินใหญ่
เป้าหมาย
...
Step 2: ใช้ลูปเพื่อให้เช็คค่าหลายรอบ ตรวจสอบb > 0 and goal > 5 ให้ goal-5 b-1 ตรวจสอบว่าa > 0 : goal-1 a-1 small+1 นอกเหนือจากนั้นให้หยุดลูป
Step 3: เมื่อออกลูปตรวจสอบว่าgoalใช้0ไหมถ้าใช่print("-1")ถ้าไม่printค่าหินก้อนเล็ก
...
```text
Step 1: อ่านจำนวนเต็ม
Step 2: หาจำนวนหินก้อนใหญ่ที่ใช้ได้จากbig = min(b,goal//5) ใช้ค่าminเพื่อไม่ให้goal//5มีค่ามากกว่าbซึ่งเป็นจำหินที่มี
Step 3: หาค่าหินเล็กจากการเอาgoal -= big*5 คือการเอาจำนวนหินก้อนใหญ่ไปคูณกับ5คือปริมาณหินใหญ่ และมาลบกับgoalก็จะได้จำนวนของหินเล็ก
Step 4: ตรวจสอบว่าgoalมีค่าน้อยกว่าหรือเท่ากับaไหมเพราะสามารถเติมจนถึงgoalได้ถ้าใช่แสดงผลgoalนอกเหนือจากนั้นแสดงคำว่า-1
```
...
```text
เพื่อสำหรับตรวจสอบความผิดพลาดและตรวจสอบว่าโปรแกรมทำงานได้อย่างถูกต้อง
```
