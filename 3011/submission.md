...
```text
Input:
รับค่าเป็นชื่อแม่สี2สี

Output:
โปรแกรมควรผลลัพธ์ของการผสมแม่สี2สี
Constraints:
ถ้ารับค่าไม่ใช่แม่สีให้แสดงว่าError
```
...
```text
Step 1: รับค่าชื่อแม่สี2สี
Step 2: ตรวจว่าค่าที่รับมา แม่สีที่ ผสม แม่สีที่2 เป็นสี...และแสดงผลสีนั้น
Step 3: ถ้าค่าที่รับมานอกเหนือจากแม่สีให้แสดงผลว่าError
```
...
```text
วิธีสุดท้ายของฉันเหมือนกับแผนแรก รับค่าชื่อแม่สี2สี ตรวจว่าค่าที่รับมา แม่สีที่ ผสม แม่สีที่2 เป็นสี...และแสดงผลสีนั้น ถ้าค่าที่รับมานอกเหนือจากแม่สีให้แสดงผลว่าError
```
...
```text
เพื่อเช็คว่าผลลัพธ์ที่แม่สีผสมกันถูกต้อง
```
...
```text
เช็คว่าถ้าที่รับมาไม่ใช่แม่สีให้แสดงผลError
```
