...
```text
ให้xรับค่าเดือนและyรับค่าวันที่ ใช้ifในการเช็คว่าxมีค่าอยู่ในช่วงระหว่างเดือนอะไรและใช้ifเช็คซ้อนอีกชั้นว่าถ้าวันที่นั้นมากกว่า21และเดือนนั้นตรงกับเดือนที่สามารถเปลี่ยนฤดูได้ไหมถ้าตรงก็ให้แสดงค่าฤดูถัดไปถ้าไม่ก็ให้แสดงฤดูที่ตรงกับเดือนนั้น
```
...
```text
Step 1:เช็คว่าเดือนที่รับค่ามามีค่าตรงกับฤดูอะไรจากโจทย์
Step 2:ถ้าเดือนนั้นตรงกับฤดูอะไรให้แสดงฤดูนั้น
Step 3:แต่ถ้าเดือนนั้นหาร3ลงตัวและวันนั้นมากกว่าเท่ากับวันที่21ก็จะให้แสดงฤดูถัดไป
```
...
```text
เพื่อเช็คว่าผลลัพธ์ตรงกับตัวอย่างที่โจทย์ให้มาไหม
```
...
```text
เพื่อเช็คว่าเงื่อนไขการเปลี่ยนฤดูใช้ได้จริงไหม
```
...
```text
คิดหลัการทำงานเขียนโปรแกรมคิดconcept
```
