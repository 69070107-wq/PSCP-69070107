...
```text
ให้หาว่าผลสลกกินแบ่ถูกรางวัลไหม
input
ผลสลากกินแบ่ง
สลากที่ซื้อ
Output
จำนวนเงินที่ถูกรางวัล
```
...
```text
รับค่าตัวแปรเป็น2ชุดมีเลขกับตัวอักษร
เช็คว่าตัวหนังสือกับเลขตรงกันไหมถ้าตรงหมดแสดงค่า1000000 
ถ้ามีแค่ตัวเลขตรงหมดแสดง 100000
ถ้าตัวหนังสือตรง แต่เลขเหมือนแค่3ตัวท้าย แสดง2000
ถ้าตัวหนังสือตรง แต่เลขเหมือนแค่2ตัวท้าย แสดง1000
ถ้าเลขเหมือนแค่3ตัวท้าย แสดง200
ถ้าเลขเหมือนแค่2ตัวท้าย แสดง100
ถ้าเหมือนแค่ตัวหนังสือแสดง20
ถ้าไม่มีแสดง0
```
...
```text
เพื่อตรวจสอบว่ามีความถูกต้องตรงกับโจทย์
```
