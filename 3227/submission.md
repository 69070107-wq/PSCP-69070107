...
```text
โจทย์ให้ฉันอ่านค่าที่ีรับมาว่าคือไพ่อะไร

Input:
รับแต้มของไพ่และกลุ่มของไพ่ โดยจะเป็นตัวอักษร 1 ตัวหรือเลข2-10 และตามด้วยตัวอักษร คือ D หรือ H หรือ S หรือ C

Output:
ค่าที่รับมาคือแปลงแล้วเป็นไพ่อะไร

Constraints:
x เป็นรหัสไพ่ที่ถูกต้อง เช่น AD, 10H, JS, KC
```
...
```text
รับค่าตัวแปรx
ให้ตัวแปรrankคือค่าx ตัวที่ซ้ายสุดถึงตัวก่อน-1
ให้ตัวแปรsuitคือค่าxตำแหน่ง-1
เช็คว่าsuitคือค่าอะไรเข้าเงื่อนไขไหนให้ตัวแปรsuit_nameค่าตามที่ตั้ง
เช็คว่าrankคือค่าอะไรเข้าเงื่อนไขไหนให้ตัวแปรrank_nameค่าตามที่ตั้ง
แสดงค่าrank_name ''of'' suit_name
```
...
```text
ใช้ตรวจสอบตามหลักการของโจทย์เพื่อหาจุดผิดพลาด
```
