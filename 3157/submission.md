...
ค่าตัว'+' หรือ '-' จำนวนnตัว

Output:
ค่าผลรวมของ + - โดย+ มีค่า10 -มีค่าเท่ากับ5
...
Step 2: รับค่าตัวหนังสือ +หรือ- จำนวนรวมnตัว
Step 3 : เช็คในลูปที่รับค่าว่าถ้าเป็น+ให้บวกตัวแปรnum2เป็น10เป็นลบให้บวกตัวแปรnum2 -5
Step 4: แสดงค่าnum2
```
...
```text
เพื่อเช็คและตรวจสอบตามเทสเคสที่โจทย์ให้มา
```
...
```text
เพื่อเช็คและตรวจสอบความถูกต้องว่าค่าจะเป็นบวก
```
