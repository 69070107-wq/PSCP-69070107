...
```text
โจทย์ให้ฉันเขียนโปรแกรมเพื่อ หาเลขจำนวนเฉพาะ (Prime Number) ที่อยู่ในช่วงตั้งแต่ start ถึง end แล้วแสดงเลขจำนวนเฉพาะทั้งหมด พร้อมบอกว่ามีทั้งหมดกี่จำนวน
Input: รับจำนวนเต็ม start และ end

Output: แสดงเลขจำนวนเฉพาะในช่วงดังกล่าว และจำนวนเลขทั้งหมด

Constraints: เลขที่น้อยกว่า 2 ไม่เป็นจำนวนเฉพาะ และต้องหารลงตัวเฉพาะ 1 กับตัวเอง
```
...
```text
Step 1: รับค่า start และ end
Step 2: วนดูตัวเลขทุกตัวในช่วง
Step 3: ตรวจว่าแต่ละตัวเป็นจำนวนเฉพาะหรือไม่
Step 4: ถ้าเป็น ให้เก็บไว้ในลิสต์
Step 5: แสดงเลขจำนวนเฉพาะและจำนวนทั้งหมด
```
...
```text
เช็คตามเงื่อนไขว่าถูกต้องตามหลักการโจทย์ไหม
```
