...
```text
เช็คตัวอักษรที่รับมาว่ามีตัวa,e,i,o,uไหมถ้ามีให้เก็บไว้ในlistและแสดงผลตัวอักษรนั้นว่ามีกี่ตัว
```
...
```text
สร้างตัวแปรรับค่า
สร้างลิสเก็บค่าตัวอักษร5อัน
ใช้for loopและเช็คในตัวแปรรับค่าว่ามีตัวอักษรที่กำหนดไหม
เช็คว่าในลิสแต่ลิสมีค่าไม่ใช่0ใช่ไหมถ้าใช่ให้แสดงค่าลิสนั้นพร้อมจำนวนที่มี
```
...
```text
เพื่อตรวจสอบข้อผิดพลาด มีerrorไหมและโปรแกรมมีการทำงานอย่างถูกต้อง
```
